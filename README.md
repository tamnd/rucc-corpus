...
1461 programs across 49 facets, grouped by the phases of the M4 plan.
...
| [reports/cost.md](reports/cost.md) | Code size, size on disk, initialized data, compile time, run time and compiler memory, per facet, each against the GCC 16 build of the same program |
