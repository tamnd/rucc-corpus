        ...
        (
            ...
            Json::array(facet.scores.iter().map(|score| {
                Json::object([
                    ...
                    ("instruction_ratio", score.instruction_ratio.map_or(Json::Null, Json::Number)),
                    ("counted", Json::int(score.counted as i64)),
                    ("instruction_delta", Json::int(score.instruction_delta)),
