...
The corpus holds 1122 programs, each written for one named transformation and each carrying the answer the generator worked out before any C was compiled. Corpus digest `31549141a8271315`.
...
|---|---|---|---|---|---|---|---|---|
| `gcc-16` | 5578 | 5578 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rucc` | 5578 | 5573 | 0 | 0 | 5 | 0 | 0 | 0 |
...
|---|---|---|---|---|---|
| `scheduling` | backend | 12 | 68 percent more | 3 percent more | 52 percent less |
| `register-alloc` | backend | 40 | 61 percent more | 1 percent more | 54 percent less |
| `simplify` | local | 8 | 54 percent more | 5 percent less | 56 percent less |
| `induction-variable` | loops | 42 | 33 percent more | 1 percent less | 52 percent less |
| `loop-restructure` | loops | 48 | 31 percent more | 1 percent more | 53 percent less |
| `switch-lowering` | backend | 9 | 30 percent more | 1 percent less | 56 percent less |
| `value-range` | global | 13 | 26 percent more | 3 percent more | 50 percent less |
| `calling-convention` | backend | 10 | 24 percent more | level | 49 percent less |

Furthest ahead:

| facet | phase | cases | code size | run time | compile time |
|---|---|---|---|---|---|
| `copy-propagation` | global | 12 | 6 percent less | 2 percent less | 49 percent less |
| `unreachable-code` | local | 8 | 4 percent less | 4 percent more | 48 percent less |
| `reachability` | interprocedural | 9 | 4 percent less | 7 percent more | 48 percent less |
| `dead-code` | local | 12 | 4 percent less | 6 percent less | 47 percent less |
| `selection` | backend | 40 | 2 percent less | 1 percent more | 47 percent less |
| `machine-peephole` | backend | 22 | 1 percent less | 3 percent less | 50 percent less |
| `constant-propagation` | global | 16 | level | 5 percent more | 48 percent less |
| `scalar-replacement` | global | 20 | level | level | 50 percent less |
...
The corpus is generated from the crates in this repository, so it is a function of the source and nothing else. Any run of the same commit produces the same 1122 programs with the same digest, and a report that disagrees with this one is a report about a different commit.
