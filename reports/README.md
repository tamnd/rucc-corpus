...
|---|---|---|---|---|---|---|---|
| `gcc-16` | 13188 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rucc` | 13183 | 0 | 0 | 5 | 0 | 0 | 0 |
...
| `code-quality:rucc` | the code rucc produces at -O2 is within ten percent of what gcc-16 produces at -O2, counted over the whole corpus by byte | 1.045 | yes |
| `compile-throughput:rucc` | rucc compiles the corpus at least as fast as gcc-16 does, which is the corpus proxy for the throughput target in spec 00 | 0.549 | yes |
