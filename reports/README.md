...
110 case results did not come out as expected. They are on the failures page, worst first.
...
|---|---|---|---|---|---|---|---|
| `gcc-16` | 9123 | 0 | 0 | 0 | 0 | 0 | 0 |
| `rucc` | 8883 | 5 | 100 | 130 | 0 | 5 | 0 |
...
| [What went wrong](failures.md) | 110 failures in full, and 130 cases a compiler said it has not built yet, grouped so that twenty cases blocked on one missing thing read as one missing thing |
...
|---|---|---|---|
| `correctness` | every case prints the answer the generator computed, on every compiler, at every level | 110.000 | no |
| `code-quality:rucc` | the code rucc produces at -O2 is within ten percent of what gcc-16 produces at -O2 | 1.085 | yes |
